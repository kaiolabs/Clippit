...
pub fn create_page() -> gtk::Widget {
    ...
    suggestions_group.set_description(Some(
        "Configure o comportamento das sugestões durante a pesquisa",
    ));
    ...
    hotkey_group.set_description(Some(
        "Configure os atalhos para voltar ao campo de pesquisa",
    ));
